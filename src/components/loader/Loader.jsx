...
function Loader() {
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-[url('https://wallpapercave.com/wp/wp2757874.jpg')] bg-cover bg-center flex flex-col justify-center items-center z-50 backdrop-blur-md">
      <div role="status" className="flex flex-col items-center">
        <svg
          aria-hidden="true"
          className="w-16 h-16 text-pink-300 animate-spin fill-purple-700 drop-shadow-xl"
          viewBox="0 0 100 101"
          fill="none"
        ...
        <p className="text-white text-lg mt-4 font-bold font-[cursive]">
          Loading
        </p>
      </div>
    </div>
